...
object libpcap:
  ...
  object types:
    ...
    object sockaddr:
      given Tag[sockaddr] = Tag.materializeCStruct2Tag[UByte, UByte]
    ...
    object sockaddr_in:
      given Tag[sockaddr_in] = Tag.materializeCStruct5Tag[UByte, UByte, UShort, UInt, CArray[CChar, Nat._8]]
    ...
    object sockaddr_in6:
      given Tag[sockaddr_in6] = Tag.materializeCStruct6Tag[UByte, UByte, UShort, UInt, CArray[Byte, Nat.Digit2[Nat._1, Nat._6]], UInt]
    ...
    object pcap_addr:
      given Tag[pcap_addr] = Tag.materializeCStruct5Tag[Ptr[Byte], Ptr[sockaddr], Ptr[sockaddr], Ptr[sockaddr], Ptr[sockaddr]]
    ...
    object pcap_pkthdr:
      given Tag[pcap_pkthdr] = Tag.materializeCStruct3Tag[timeval, CUnsignedInt, CUnsignedInt]
    ...
    object bpf_insn:
      given Tag[bpf_insn] = Tag.materializeCStruct4Tag[CUnsignedShort, CUnsignedChar, CUnsignedChar, CUnsignedInt]
    ...
    object bpf_program:
      given Tag[bpf_program] = Tag.materializeCStruct2Tag[CUnsignedInt, Ptr[bpf_insn]]
